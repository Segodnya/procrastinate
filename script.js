// Add text-image objects for each phrase
let phrases = [
  {
...
button.addEventListener("click", function () {
  ...
  // Add cozy animations for text and images
  smoothly(phrase, "textContent", randomElement.text);
  smoothly(image, "src", randomElement.image);

  // Add font-size changer for long phrases
...
// Add some looped animations when page loads
for (let i = 0; i <= 2; i++) {
